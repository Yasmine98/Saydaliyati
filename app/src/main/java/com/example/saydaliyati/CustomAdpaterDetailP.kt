...
data class CostumAdapterDetailP(val ctx: Context, val data: pharmacie) : BaseAdapter()
{
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        var holder : ViewHolder
            ...
            view = LayoutInflater.from(ctx).inflate(R.layout.pharma_detail_fragment, p2, false)
            Toast.makeText(ctx,"message",Toast.LENGTH_SHORT).show()
            val textView1 = view?.findViewById(R.id.idP) as TextView
            val textView2 = view?.findViewById(R.id.nom) as TextView
        ...
        holder.textView1.setText(data.id)
        holder.textView2.setText(data.adrpost)
        var etat : String
        etat = "fermé"
    ...
    override fun getItemId(p0: Int) = data.hashCode().toLong()
