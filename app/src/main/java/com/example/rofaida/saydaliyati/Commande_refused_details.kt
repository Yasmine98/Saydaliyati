...
class Commande_refused_details : Fragment(), View.OnClickListener {
    ...
    private lateinit var message_refus_: TextView
    ...
    override fun onCreateView(
        ...
        view1 = inflater.inflate(R.layout.fragment_commande_refused_details, container, false)
    ...
    private fun initViews() {
        ...
        message_refus_ = view1.findViewById(R.id.message_refus) as TextView
        ...
        message_refus_.setText(commande!!.motifRefus)
